    ...
    editormd.defaults = {
        ...
        lang: {
            ...
            toolbar: {
                ...
                hr: "分隔線",
                link: "超連結",
                "reference-link": "號碼引用(類似維基百科)",
                image: "增加圖片",
                code: "字體高亮",
                "preformatted-text": "程式碼",
                "code-block": "程式碼(選擇語言)",
                table: "表格",
                datetime: "增加時間",
                emoji: "Emoji表情",
                "html-entities": "HTML特殊符號",
                pagebreak: "插入分页符",
                "goto-line": "跳转到行",
                watch: "開啟畫面預覽",
                unwatch: "關閉畫面預覽",
                preview: "全框預覽",
                fullscreen: "全視窗（按ESC還原）",
                clear: "清除所有內容",
                search: "搜尋",
                help: "使用帮助",
            ...
            dialog: {
                ...
                image: {
                    ...
                    alt: "圖片描述",
                    uploadButton: "本地上传",
                    imageURLEmpty: "圖片網址不能是空的。",
                    uploadFileEmpty: "错误：上传的图片不能为空。",
                    formatNotAllowed: "错误：只允许上传图片文件，允许上传的图片文件格式有："
                },
                preformattedText: {
                    title: "程式碼",
                    emptyAlert: "請正確填寫程式碼內容"
                },
                codeBlock: {
                    title: "程式碼",
                    selectLabel: "程式語言 : ",
                    ...
                    otherLanguage: "其他語言",
                    unselectedLanguageAlert: "請選擇正確內容所屬的程式語言",
                    codeEmptyAlert: "請正確填寫程式碼內容"
                },
                htmlEntities: {
                    title: "HTML 特殊符號"
                },
